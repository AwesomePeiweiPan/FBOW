...
const int neighborThresholdImages0=2;
//分数高于多少才被认为有共视；
...
int main(int argc, char **argv){
    ...
    readFromTxt("/home/peiweipan/fbow/ImageMatch/scores.txt", scores);
    ...
    writeGroupedSequencesToFile(BestSequences, "/home/peiweipan/fbow/ImageMatch/Sequence.txt");

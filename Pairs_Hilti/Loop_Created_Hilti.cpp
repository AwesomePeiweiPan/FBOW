...
double thresholdScore = 0.9; 
//在Images0中至少连续多少张图片才被认定为有效图片 默认5
const int ConsecutiveImages =1;
//在Images0中相邻照片序数相差多少才合适 默认3
const int neighborThresholdImages0=1;
//在Images1中每个组至少要有多少张照片 默认4
const double thresholdSecondConseutiveImages = 1;
//在Images1中相邻照片序数相差多少才合适 默认3
const int neighborThreshold = 1;
//////基本的文件路径
//地图匹配结果
std::string GroupSequence = "/home/peiweipan/fbow/Hilti_Maps/GroupSequence/GroupSequence.txt"; 
//Scores所在的文件夹地址
std::string ScoresFiles = "/home/peiweipan/fbow/Hilti_Maps"; 
//关键帧源文件
std::string cam0_Images = "/home/peiweipan/Projects/DroidSlam/HiltiData/KeyframesInte/cam0"; 
std::string cam1_Images = "/home/peiweipan/Projects/DroidSlam/HiltiData/KeyframesInte/cam1"; 
//输出回环的文件夹
fs::path loop_Output = "/home/peiweipan/Projects/DroidSlam/HiltiData/Loop";

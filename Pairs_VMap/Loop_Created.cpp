...
//////基本的文件路径
//地图匹配结果
std::string GroupSequence = "/home/peiweipan/fbow/Vmap_Maps/site1/GroupSequence/GroupSequence.txt"; 
//Scores所在的文件夹地址
std::string ScoresFiles = "/home/peiweipan/fbow/Vmap_Maps/site1"; 
//关键帧源文件
std::string cam0_Images = "/home/peiweipan/Projects/DroidSlam/VMapData/Keyframes/site1/cam0"; 
std::string cam1_Images = "/home/peiweipan/Projects/DroidSlam/VMapData/Keyframes/site1/cam1"; 
//输出回环的文件夹
fs::path loop_Output = "/home/peiweipan/Projects/DroidSlam/VMapData/Loop_new/site1";
